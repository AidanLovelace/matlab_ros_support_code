    ...
    methods
        function r = rosClassHandle_UR5e
            ...
            r.grip_action_client      = rosactionclient('/gripper_controller/follow_joint_trajectory', ...
                                                        ...
                                                        'DataFormat','struct');
            r.grip_action_client.ActivationFcn = [];
            ...
            r.pick_traj_act_client    = rosactionclient('/pos_joint_traj_controller/follow_joint_trajectory',...
                                                       'control_msgs/FollowJointTrajectory', ...
                                                       'DataFormat', 'struct');
            r.pick_traj_act_client.ActivationFcn = [];
            ...
            r.gik_weights              = [0.25, 0.1];
            r.gik                     = generalizedInverseKinematics;
            r.gik.RigidBodyTree = r.UR5eROBOT;
            r.gik.ConstraintInputs = {'pose', 'jointbounds'};

            r.jointCon = constraintJointBounds(r.UR5eROBOT);
            r.jointCon.Bounds = [-2.00, -pi/4, -pi/8, -pi+0.05, -pi/4, -pi; ...
